  ...
  return (
    <div className="rounded-3xl bg-white ring-1 ring-neutral-200/70 overflow-hidden">
      <div className="flex items-center justify-between gap-3 border-b border-neutral-200/70 p-4">
        ...
        <a
        href={`/api/letters/download?path=${encodeURIComponent(filePath)}&letterId=${encodeURIComponent(letterId)}`}
        className="shrink-0 rounded-2xl px-4 py-2 text-sm font-semibold text-black
